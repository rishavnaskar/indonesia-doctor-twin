...
- Whether the group employs its clinicians or contracts them, which is the Penda lesson, and the difference between mandating a workflow and hoping for adoption.
...
- **60–70% of the task-minutes**, i.e. the system does the history, the drafting, the retrieval, the checking, the documentation, the coding, the follow-up; the doctor does the judging and signs. This is achievable now, is where every credible deployment in the world sits, and it produces the same throughput outcome you actually want.
...
### 3. Health data must stay in Indonesia, and that isn't negotiable
